...
func (m *MockMetricsInterface) Record(ctx context.Context, caller string, key model.Key, duration time.Duration, err *error) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Record", ctx, caller, key, duration, err)
}

// Record indicates an expected call of Record.
func (mr *MockMetricsInterfaceMockRecorder) Record(ctx, caller, key, duration, err interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Record", reflect.TypeOf((*MockMetricsInterface)(nil).Record), ctx, caller, key, duration, err)
}
