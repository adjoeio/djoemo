...
func (m *MockLogInterface) WithContext(ctx context.Context) logger.LogInterface {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WithContext", ctx)
	ret0, _ := ret[0].(logger.LogInterface)
	return ret0
}
...
func (m *MockLogInterface) WithField(field string, value any) logger.LogInterface {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WithField", field, value)
	ret0, _ := ret[0].(logger.LogInterface)
	return ret0
}

// WithField indicates an expected call of WithField.
func (mr *MockLogInterfaceMockRecorder) WithField(field, value interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WithField", reflect.TypeOf((*MockLogInterface)(nil).WithField), field, value)
}

// WithFields mocks base method.
func (m *MockLogInterface) WithFields(fields map[string]any) logger.LogInterface {
	m.ctrl.T.Helper()
